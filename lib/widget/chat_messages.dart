...
class ChatMessages extends StatelessWidget {
  const ChatMessages({super.key, required this.senderId , required this.receiverId});
  ...
  Widget build(BuildContext context) {
    ...
    final String idd = 'LiWZNGDFgjTM8MrNCosTqkPBOBI2';
      ...
      builder: (context, snapshot) {
        ...
        return  ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            if((chatMessage['senderId'] == senderId && chatMessage['receiverId']==receiverId) ||(chatMessage['senderId'] == receiverId && chatMessage['receiverId']==senderId) ){
